...
if __name__ == "__main__":
    ...
    input_data_path = root_path + "/AnfisTrainingSet_from_PPO_1k.txt"
    res = do_kmeans_clustering_for_anfis(
        input_data_path, n=3, use_cols=4,
        sigma_method="featurewise_nn", beta=0.55,
        plot=True,
        export_json_path= "/Users/tommykiss/mujoco-py/data/kmeans_dagger0_1k_k3.json"  # z.B. root_path + "/anfis_rules_k12.json"
    )
